...
python -m experiments.maml --dataset BTAF --seed 10 --order 1 --n 1 --k 5 --q 15 --meta-batch-size 4 \
    --inner-train-steps 1 --inner-val-steps 10 --inner-lr 0.1 --meta-lr 0.001 --eval-batches 80 \
    --epochs 50 --epoch-len 1000
